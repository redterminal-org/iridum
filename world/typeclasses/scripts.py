...
class Script(DefaultScript):
    ...
    !!!IMPORTANT CHANGE FOR CHILD CLASSES!!!:
        ...
        Example:
            ...
            - gives "Beginner Builder" "create" permission and "Expert
              Builder"s "global_script" permission ("create" for creating on
              Objects, and "global_script" to create a global_script from this
              typeclass.
    ...
    * Hook methods (should also include self as the first argument):
    ...
    def at_script_creation(self):
        ...
        # add generic script tag
        self.tags.add("script", category="generic")

    def at_server_reload(self):
        self.db.time_remaining = self.time_until_next_repeat()
