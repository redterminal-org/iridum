...
#### Please prefix all prototypes with "EDITABLE_" in this file ####
...
EDITABLE_GUESTBOOK = {
    "key": "Guestbook",
    "aliases": ["guestbook", "book"],
    "typeclass": "world.objects.guestbook.Guestbook",
    "attrs": [
        (
            "desc",
            """This is a big, leather-bound book with the letters |rGUESTBOOK|n
written on it.

Use the |c'help guestbook'|n command for help to use the
Guestbook.""",
            None,
        ...
        (
            "get_err_msg",
            """Please let this $protkey(key) at it's place, so other people can
have alook at it and maybe sign it.""",
            None,
            "attredit:perm(Expert Builder);attrread:all();",
        ),
    ],
    "prototype_tags": ["editable"],
    "prototype_locks": "spawn:perm(Expert Builder);edit:perm(Expert Builder)",
    "prototype_desc": "A Guestbook to read, sign and and delete entries.",
}

EDITABLE_TODOLIST = {
    "key": "TODO List",
    "aliases": ["TODO", "list"],
    "typeclass": "world.objects.todolist.TodoList",
    "attrs": [
        (
            "desc",
            """You see a case of TODO notes. You can add, edit, comment and
delete these notes. You can also add ideas for building things and
discuss them here.

Use the |c'help TODO'|n command for help to use the TODO List.""",
            None,
            "attredit:perm(Expert Builder);attrread:all();",
        ),
        (
...
work on it.""",
    ...
    "prototype_tags": ["editable"],
    "prototype_locks": "spawn:perm(Expert Builder);edit:perm(Expert Builder)",
    "prototype_desc": "A TODO list with entries and comments",
}
