...
#### Please prefix all creature prototypes with "CREA_" in this file ####

#### Imports ####

### Proto: CREA_GOBLIN: a random Goblin ###
CREA_GOBLIN = {
    # When using the key "Random Goblin" a random male or female Goblin will
    # be created with a random name.
    "key": "Random Goblin",
    "typeclass": "world.objects.creatures.goblin.Goblin",
    "prototype_tags": ["creature"],
    "prototype_locks": "spawn:all();edit:all()",
    "prototype_desc": "A random Goblin with random gender and name,"
                      " that follows you when given food.",
}
